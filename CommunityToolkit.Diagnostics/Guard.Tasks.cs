...
partial class Guard
{
    ...
    public static void IsCompleted(Task task, [CallerArgumentExpression(nameof(task))] string name = "")
    {
        if (task.IsCompleted)
        {
            return;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void IsNotCompleted(Task task, [CallerArgumentExpression(nameof(task))] string name = "")
    {
        if (!task.IsCompleted)
        {
            return;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void IsCompletedSuccessfully(Task task, [CallerArgumentExpression(nameof(task))] string name = "")
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void IsNotCompletedSuccessfully(Task task, [CallerArgumentExpression(nameof(task))] string name = "")
    {
        if (task.Status != TaskStatus.RanToCompletion)
        {
            return;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void IsFaulted(Task task, [CallerArgumentExpression(nameof(task))] string name = "")
    {
        if (task.IsFaulted)
        {
            return;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void IsNotFaulted(Task task, [CallerArgumentExpression(nameof(task))] string name = "")
    {
        if (!task.IsFaulted)
        {
            return;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void IsCanceled(Task task, [CallerArgumentExpression(nameof(task))] string name = "")
    {
        if (task.IsCanceled)
        {
            return;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void IsNotCanceled(Task task, [CallerArgumentExpression(nameof(task))] string name = "")
    {
        if (!task.IsCanceled)
        {
            return;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void HasStatusEqualTo(Task task, TaskStatus status, [CallerArgumentExpression(nameof(task))] string name = "")
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void HasStatusNotEqualTo(Task task, TaskStatus status, [CallerArgumentExpression(nameof(task))] string name = "")
    {
        if (task.Status != status)
        {
            return;
