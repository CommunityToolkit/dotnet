...
{
    /// <summary>
    /// The <see name="ReadOnlySequence{T}"/> instance currently in use.
    /// </summary>
    ...
    public sealed override long Length
    {
        ...
        get
        {
            ReadOnlySequenceStream.ValidateDisposed(this.disposed);
    ...
    public sealed override long Position
    {
        ...
        {
            ReadOnlySequenceStream.ValidateDisposed(this.disposed);
            ReadOnlySequenceStream.ValidatePosition(value, this.source.Length);
    ...
    {
        throw ReadOnlySequenceStream.GetNotSupportedException();
    }
    ...
    public sealed override long Seek(long offset, SeekOrigin origin)
    {
        ...
        long index = origin switch
        {
            ...
            _ => ReadOnlySequenceStream.ThrowArgumentExceptionForSeekOrigin()
        };

        ReadOnlySequenceStream.ValidatePosition(index, this.source.Length);
    ...
    {
        ReadOnlySequenceStream.ValidateDisposed(this.disposed);
        ReadOnlySequenceStream.ValidateBuffer(buffer, offset, count);
